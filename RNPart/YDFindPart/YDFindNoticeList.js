...
import YDFindNotoceItem from './YDFindNotoceItem';
import JWBaseWebView from '../JWBaseWebView';

class YDFindNoticeList extends Component{
    ...
    fetchData()
    {
        var url = 'http://tapi.youdingkeji.com/yiding-rest/rest/message/noticeList.json';
        // post请求描述
        var requestDesc = {
            method:'POST',
            headers:{
            ...
            body:"appType=20001&channel=AppStore_test&deviceType=1&device_serial_id=565C3B6C-EA57-4B62-9DDF-1A734A825F5A&idfa=&phoneSystemVersion=11.4&supperUserId=&token=&userId=&versionName=1.4.0&pageNo="+ this.page
        };
...
module.exports = YDFindNoticeList;